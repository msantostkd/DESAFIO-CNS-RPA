...
CONFIG = {
    "CLIENT_ID": os.getenv("BB_CLIENT_ID", "eyJpZCI6ImU0NTYiLCJjb2RpZ29QdWJsaWNhZG9yIjowLCJjb2RpZ29Tb2Z0d2FyZSI6MTYzMDUwLCJzZXF1ZW5jaWFsSW5zdGFsYWNhbyI6MX0"),
    "CLIENT_SECRET": os.getenv("BB_CLIENT_SECRET", "eyJpZCI6IjkzY2Q2NGQtNWE5Yy00ZTA5LTk4ZmEtYmI0ZDcyMDIyMyIsImNvZGlnb1B1YmxpY2Fkb3IiOjAsImNvZGlnb1NvZnR3YXJlIjoxNjMwNTAsInNlcXVlbmNpYWxJbnN0YWxhY2FvIjoxLCJzZXF1ZW5jaWFsQ3JlZGVuY2lhbCI6MiwiYW1iaWVudGUiOiJob21vbG9nYWNhbyIsImlhdCI6MTc2NDA3NjYwMzQ5OX0"),
    "APP_KEY": os.getenv("BB_APP_KEY", "2dc673fdaa5e4db68f1019d2d9027c01"),
